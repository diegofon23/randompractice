import random
#value = random.random()#or random.uniform(1,10)
#print(value)
#greetings =['hello','hi','hey','howdy','hola']
#colors =['red','black','green']
#value = random.randint(1,6)#for whole number
#value=random.choice(greetings)
#value = random.choices(colors,weights=[18,18,2], k =10)#weight measures possiblity of the answer coming. k shows how many times itll show. 
#print(value)
